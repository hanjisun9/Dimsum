        ...
        <section id="contact" className="bg-[#FFF1F1] py-20 px-6">
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
                <div className="flex-1 text-[#7D2017]">
                    <p className="text-sm tracking-widest mb-3">WE ARE HERE TO HELP YOU</p>
                    <h1 className="text-5xl font-light leading-tight mb-6"><span className="font-bold">Discuss</span> Your <br />Brand Solution <br />Needs</h1>
                    <p className="max-w-md mb-8">Create modern, impactful, and visually strong packaging that represents your brand identity.</p>
                ...
                <div className="flex-1 bg-white rounded-3xl shadow-lg p-8 w-full max-w-xl">
                    <div className="space-y-5 text-[#7D2017]">
                        <div>
                            <label className="block mb-2">Brand / Company Name</label>
                        ...
                        <div className="flex justify-end">
                            <button className="bg-[#B54141] text-white rounded-full font-bold py-2 px-4 hover:opacity-90 transition">Get a Solution</button>
                        </div>
                    </div>
                </div>
            </div>
